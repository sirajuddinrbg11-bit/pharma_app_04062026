...
# get user Input
DD=st.number_input("Drug Dosage in mg",min_value=0.0)
SBP=st.number_input("Systolic Blood Pressure",min_value=0.0)
HR=st.number_input("Heart Rate (BPM)",min_value=0.0,max_value=5)
LTI=st.number_input("Liver Toxicity Index (U/L)",min_value=0.0)
BGL=st.number_input("Blood Glucose Level",min_value=0.0)
